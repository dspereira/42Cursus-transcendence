...
urlpatterns = [
	...
	path('accept_request/', views.accept_friend_request, name='accept_request'),			# Para remover depois de testes
	path('decline_request/', views.decline_friend_request, name='decline_request'),			# Para remover depois de testes
	path('remove_friendship/', views.remove_friendship, name='remove_friendship'),			# Para remover depois de testes
