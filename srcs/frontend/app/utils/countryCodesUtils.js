const countryCodesArr = [{"country":"Afghanistan","code":"93","iso":"AF"},
...
const getCountryFlag = function(countryIso) {
	if (!countryIso)
		return ;

	const baseRegionalIndicator = 0x1F1E6;
	const unicodeA = 'A'.charCodeAt(0);
	let flag = "";
	let letterCode;

	for(let i=0; i < 2; i++) {
		letterCode = countryIso[i].charCodeAt(0);
		flag += `&#x${(baseRegionalIndicator + letterCode - unicodeA).toString(16)};`;
	}
	return flag;
}

const getCountryCodesOptions = function() {
	let optionsStr = "";
